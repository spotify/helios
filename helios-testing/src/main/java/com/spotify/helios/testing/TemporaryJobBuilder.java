...
public class TemporaryJobBuilder {
  ...
  TemporaryJobBuilder(final Set<String> hosts, final Deployer deployer,
    ...
    this.prober = checkNotNull(defaultProber, "defaultProber");
  ...
  /**
   * Deploys the job to the single helios-solo host.
   *
