...
class Prober {
  ...
  boolean probe(final String host, final PortMapping portMapping) {
  ...
  private boolean probeUdpPort(final String host, final PortMapping portMapping) {
  ...
  private boolean probeTcpPort(final String host, final PortMapping portMapping) {
    final Integer port = portMapping.getExternalPort();
