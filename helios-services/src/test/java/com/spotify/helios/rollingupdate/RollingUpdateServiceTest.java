...
public class RollingUpdateServiceTest {

  @Test
  public void testHostMatcher() {
    final Map<String, Map<String, String>> hostsAndLabels = ImmutableMap.of(
    ...
    final RollingUpdateService.HostMatcher matcher =
        new RollingUpdateService.HostMatcher(hostsAndLabels);
