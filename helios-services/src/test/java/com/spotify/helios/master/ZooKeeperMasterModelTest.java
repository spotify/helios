...
import static com.spotify.helios.master.ZooKeeperMasterModel.rolloutOptionsWithFallback;
...
public class ZooKeeperMasterModelTest {
  ...
  public void testRolloutOptionsWithFallback() throws Exception {
    final RolloutOptions options = RolloutOptions.newBuilder()
        .setTimeout(123L)
        .setParallelism(2)
        .build();
    ...
    assertThat(rolloutOptions, equalTo(RolloutOptions.newBuilder()
        .setParallelism(2)
        .setTimeout(123L)
        .setOverlap(true)
        .setToken("bar")
