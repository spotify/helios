...
public class PortAllocatorTest {
  ...
  private static final ExternalPort EXT_PORT_18 = ExternalPort.of(18);

  @Test
  public void testAllocate() throws Exception {
    final PortAllocator sut = new PortAllocator(10, 20);
    final Map<String, PortMapping> mapping = ImmutableMap.of(
        "p1", PortMapping.of(17),
        "p2", PortMapping.of(18, EXT_PORT_18));
    final Set<ExternalPort> used = ImmutableSet.of(ExternalPort.of(10), ExternalPort.of(11));
    final Map<String, ExternalPort> allocation = sut.allocate(mapping, used);
    assertEquals(ImmutableMap.of("p1", ExternalPort.of(12), "p2", EXT_PORT_18), allocation);
  }
  ...
  public void testInsufficientPortsFail2() throws Exception {
    ...
    final Map<String, PortMapping> mapping = ImmutableMap.of("p1", PortMapping.of(1),
                                                             "p2", PortMapping.of(2),
                                                             "p3", PortMapping.of(4),
                                                             "p4", PortMapping.of(18, EXT_PORT_18));
    final Set<ExternalPort> used = ImmutableSet.of();
    final Map<String, ExternalPort> allocation = sut.allocate(mapping, used);
    assertNull(allocation);
  }
  ...
  public void verifyStaticPortsNotCheckedAgainstRange() throws Exception {
    ...
    final Set<ExternalPort> used = ImmutableSet.of();
    final Map<String, ExternalPort> allocation = sut.allocate(mapping, used);
    assertEquals(ImmutableMap.of("p1", ExternalPort.of(10), "p2", EXT_PORT_18), allocation);
  }
}
